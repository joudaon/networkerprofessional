...
namespace Networker {
    ...
    public partial class GetUserJson : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(GetUserJson).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(GetUserJson));
        ...
        private string FindResource() {
            string[] resources = typeof(GetUserJson).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".GetUserJson.g.xaml") || resource.Equals("GetUserJson.g.xaml"))) {
                    return resource;
                }
            }
