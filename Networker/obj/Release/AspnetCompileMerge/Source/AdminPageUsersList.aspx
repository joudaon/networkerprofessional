<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminPageUsersList.aspx.cs" Inherits="Networker.AdminPageUsersList" MasterPageFile="~/MasterPage.Master" %>
    ...
    <div class="container">
        <div class="row">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:networkerDB %>"
                SelectCommand="SELECT [Id], [Name], [LastName], [Telephone], [Email] FROM [Users] WHERE (([Active] = @Active) AND ([Id] &gt; @Id)) ORDER BY [Name]">
                <SelectParameters>
